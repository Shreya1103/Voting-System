...
contract("Election", function(accounts) {
  ...
  it("it initializes the candidates with the correct values", function() {
    return Election.deployed().then(function(instance) {
      ...
      assert.equal(candidate[1], "UPES", "contains the correct name");
      ...
      assert.equal(candidate[1], "Abhirup Sir", "contains the correct name");
      assert.equal(candidate[2], "Indian National Congress", "contains the correct party");
      assert.equal(candidate[3], 0, "contains the correct votes count");
      return electionInstance.candidates(3);
    }).then(function(candidate) {
      assert.equal(candidate[0], 3, "contains the correct id");
      assert.equal(candidate[1], "Molshree Gupta", "contains the correct name");
      ...
      assert.equal(candidate[1], "Naman Shankhdhar", "contains the correct name");
      ...
      assert.equal(candidate[1], "Shreya Arora", "contains the correct name");
